...
//
      gSystem->Load("$MUSE_BUILD_BASE/Stntuple/lib/libStntuple_base.so");
      gSystem->Load("$MUSE_BUILD_BASE/Stntuple/lib/libStntuple_obj.so");
      gSystem->Load("$MUSE_BUILD_BASE/Stntuple/lib/libStntuple_loop.so");
      gSystem->Load("$MUSE_BUILD_BASE/Stntuple/lib/libStntuple_alg.so");
      gSystem->Load("$MUSE_BUILD_BASE/Stntuple/lib/libStntuple_ana.so");
      gSystem->Load("$MUSE_BUILD_BASE/Stntuple/lib/libStntuple_val.so");
      gSystem->Load("$MUSE_BUILD_BASE/Stntuple/lib/libStntuple_val.so");
      gSystem->Load("$MUSE_BUILD_BASE/TrkAna/lib/libtrkana.so");
      gSystem->Load("$MUSE_BUILD_BASE/mu2eii/lib/libmu2eii_stat.so");
      gSystem->Load("$MUSE_BUILD_BASE/mu2eii/lib/libmu2eii_calc.so");
      gSystem->Load("$MUSE_BUILD_BASE/mu2eii/lib/libmu2eii_ana.so");
